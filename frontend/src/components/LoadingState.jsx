    ...
    >
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '24px' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '24px' }}>
          {/* 3D Icon Skeleton */}
          <div className="shimmer-skeleton" style={{ width: '90px', height: '90px', borderRadius: '50%' }} />
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: '8px' }}>
            ...
            <div className="shimmer-skeleton" style={{ width: '80px', height: '16px', borderRadius: '6px' }} />
          </div>
        </div>
      </div>

      {/* Metrics Grid: 4 Glass Cards Shimmer */}
      <div style={{
        display: 'grid',
        ...
        {[1, 2, 3, 4].map((item) => (
          ...
          >
            ...
            <div className="shimmer-skeleton" style={{ width: '100px', height: '28px', borderRadius: '6px' }} />
          </div>
        ))}
      </div>
